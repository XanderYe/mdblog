...
<input name="title" id="title" value="${topic.tname}" hidden="hidden">
<!--header-->
<#include "/header.ftl">
<!--nav-->
<#include "/nav.ftl">
        ...
        <div class="prev-page mdui-col-xs-6">
            <#if articles??>
                <#if (articles.pageNum > 1)>
                    <a class="next" title="" href="${ctx}/topic/${topic.tid}/page/${articles.prePage}">
                        <button class="mdui-btn mdui-btn-icon mdui-ripple mdui-float-left" mdui-tooltip="{content: '上一页'}">
        ...
        <div class="next-page mdui-col-xs-6">
            <#if articles??>
                <#if (articles.pageNum < articles.pages)>
                    <a class="next" title="" href="${ctx}/topic/${topic.tid}/page/${articles.nextPage}">
                        <button class="mdui-btn mdui-btn-icon mdui-ripple mdui-float-right" mdui-tooltip="{content: '下一页'}">
...
<!--footer-->
<#--<#include "/footer.ftl">-->
<button class="mdui-fab mdui-fab-fixed mdui-ripple mdui-color-theme-accent mdui-fab-hide" id="scrolltop">
